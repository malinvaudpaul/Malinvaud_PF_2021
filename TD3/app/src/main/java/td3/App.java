...
import td3.exercice1.paires.IPaire;
import td3.exercice1.paires.Paire;
import td3.exercice1.arbresgeneriques2.Entier;
import td3.exercice1.commandes.Categorie;
import td3.exercice1.commandes.Commande;
import td3.exercice1.commandes.DAO;
import td3.exercice1.commandes.Produit;
import td3.exercice1.arbresgeneriques2.Chaine;
...
public class App {
    ...
    public static void question31() {
        final td3.exercice1.arbres.Arbre f1 = new td3.exercice1.arbres.Feuille(1);
        final td3.exercice1.arbres.Arbre f2 = new td3.exercice1.arbres.Feuille(2);
        final td3.exercice1.arbres.Arbre n1 = new td3.exercice1.arbres.Noeud(List.of(f1, f2));
        final td3.exercice1.arbres.Arbre f3 = new td3.exercice1.arbres.Feuille(3);
        final td3.exercice1.arbres.Arbre n2 = new td3.exercice1.arbres.Noeud(List.of(n1, f3));
    ...
    public static void question32() {
        ...
        final td3.exercice1.arbresgeneriques1.Arbre<Integer> if1 = new td3.exercice1.arbresgeneriques1.Feuille<>(1);
        final td3.exercice1.arbresgeneriques1.Arbre<Integer> if2 = new td3.exercice1.arbresgeneriques1.Feuille<>(2);
        final td3.exercice1.arbresgeneriques1.Arbre<Integer> in1 = new td3.exercice1.arbresgeneriques1.Noeud<>(
                List.of(if1, if2));
        final td3.exercice1.arbresgeneriques1.Arbre<Integer> if3 = new td3.exercice1.arbresgeneriques1.Feuille<>(3);
        final td3.exercice1.arbresgeneriques1.Arbre<Integer> in2 = new td3.exercice1.arbresgeneriques1.Noeud<>(
                List.of(in1, if3));
        ...
        final td3.exercice1.arbresgeneriques1.Arbre<String> sf1 = new td3.exercice1.arbresgeneriques1.Feuille<>("a");
        final td3.exercice1.arbresgeneriques1.Arbre<String> sf2 = new td3.exercice1.arbresgeneriques1.Feuille<>("b");
        final td3.exercice1.arbresgeneriques1.Arbre<String> sn1 = new td3.exercice1.arbresgeneriques1.Noeud<>(
                List.of(sf1, sf2));
        final td3.exercice1.arbresgeneriques1.Arbre<String> sf3 = new td3.exercice1.arbresgeneriques1.Feuille<>("c");
        final td3.exercice1.arbresgeneriques1.Arbre<String> sn2 = new td3.exercice1.arbresgeneriques1.Noeud<>(
                List.of(sn1, sf3));
    ...
    public static void question33() {
        ...
        final td3.exercice1.arbresgeneriques2.Arbre<Entier> if1 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Entier(1));
        final td3.exercice1.arbresgeneriques2.Arbre<Entier> if2 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Entier(2));
        final td3.exercice1.arbresgeneriques2.Arbre<Entier> in1 = new td3.exercice1.arbresgeneriques2.Noeud<>(
                List.of(if1, if2));
        final td3.exercice1.arbresgeneriques2.Arbre<Entier> if3 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Entier(3));
        final td3.exercice1.arbresgeneriques2.Arbre<Entier> in2 = new td3.exercice1.arbresgeneriques2.Noeud<>(
                List.of(in1, if3));
        System.out.println(in2.taille());
        ...
        final td3.exercice1.arbresgeneriques2.Arbre<Chaine> sf1 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Chaine("a"));
        final td3.exercice1.arbresgeneriques2.Arbre<Chaine> sf2 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Chaine("b"));
        final td3.exercice1.arbresgeneriques2.Arbre<Chaine> sn1 = new td3.exercice1.arbresgeneriques2.Noeud<>(
                List.of(sf1, sf2));
        final td3.exercice1.arbresgeneriques2.Arbre<Chaine> sf3 = new td3.exercice1.arbresgeneriques2.Feuille<>(
                new Chaine("c"));
        final td3.exercice1.arbresgeneriques2.Arbre<Chaine> sn2 = new td3.exercice1.arbresgeneriques2.Noeud<>(
                List.of(sn1, sf3));
        System.out.println(sn2.taille());
